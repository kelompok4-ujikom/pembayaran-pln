...
<head>
  ...
  <title>PLN BANKING | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="assets/index3.html" class="brand-link">
      <img src="assets/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light"><b>PLN</b></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Zulfikar Augusta</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?= date('Y') ?> <a href="https://github.com/kelompok4-ujikom/pembayran-pln">Project-Pembayaran-PLN</a>.</strong> All rights
    reserved.
  </footer>
